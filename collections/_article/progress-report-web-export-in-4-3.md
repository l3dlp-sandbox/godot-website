...
A few months ago, I took over [Fabio Alessandrelli's (@faless)](https://github.com/Faless/) responsibilities as [Web Platform Lead](https://contributing.godotengine.org/en/latest/development/workflows/areas.html) for Godot to reduce his task load and accelerate the pace at which our Web platform exports continue to improve.
