...
Below I list some of our top priorities on the [rendering team](https://contributing.godotengine.org/en/latest/development/workflows/areas.html) for Godot 4.1 along with a brief description. These are presented in no particular order and are grouped based on whether they relate to performance improvements, stability, or usability.
