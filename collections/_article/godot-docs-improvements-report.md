...
We have new [content guidelines](https://contributing.godotengine.org/en/latest/development/documentation/content_guidelines.html) to define what should and shouldn't go into the docs.
